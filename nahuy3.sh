...
rm -rf $folder/usr/share/andronix/firstrun
...
rm -rf $folder/erc/skel/.local/share/applications
...
sed -i 's/--exit-with-session //g' $folder/etc/skel/.xsession
...
if [[ -n "$TOKEN" ]]; then
install_modded_os "https://github.com/profernick/Andronix-Modded-Os-Cracked/releases/download/kde_ubuntu_debian/debian_mod.tar.xz"
else
install_modded_os "https://github.com/profernick/Andronix-Modded-Os-Cracked/releases/download/kde_ubuntu_debian/debian_mod.tar.xz"
fi
